...
def display_distribution_table(df, golongan):
    ...
    st.dataframe(display_df[cols_to_display], hide_index=True, use_container_width=True)
...
if __name__ == "__main__":
    ...
    st.markdown("""
        <style>
            ...
            /* Hanya judul utama (h1) yang di tengah */
            h1 { text-align: center; }
            /* Semua header lain (h2, h3) akan rata kiri secara default */
            
            /* Memberi sedikit jarak pada tombol agar sejajar dengan header */
            div.stButton {
                padding-top: 30px;
            }
        </style>
    ...
    # Membuat kolom untuk header dan tombol "Muat Ulang"
    ...
    with col_button:
        ...
        if st.button("🔄 Muat Ulang Data"):
            st.cache_data.clear()
            st.success("Cache dihapus! Memuat ulang data...")
            st.rerun()
